...
cdef double precip_source_to_thetal(double p0, double T, double qr) nogil
...
cdef double conv_q_rai_to_q_vap(double q_rai, double q_tot, double q_liq, double q_ice, double T, double p, double rho) nogil
cdef double conv_q_ice_to_q_snw(double q_ice, double q_tot, double q_liq, double T, double p0, double rho) nogil

cdef mph_struct microphysics_precip_src(str rain_model, str snow_model,\
                                        double qt, double ql,\
                                        double qr, double qi, double qs,\
                                        double area, double T, double p0,\
                                        double rho, double dt) nogil
