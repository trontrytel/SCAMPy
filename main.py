...
def main_scampify(namelist, paramlist, scampifylist):
    import scampify
    Simulation = scampify.Scampify1d(namelist, paramlist, scampifylist)
    Simulation.initialize(namelist, paramlist, scampifylist)
    Simulation.run()
